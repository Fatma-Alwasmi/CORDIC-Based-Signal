...
HD_PWD='D:/cmpen_417_final_part3/cmpen_417_final_part3.runs/design_1_top_fpga417_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_top_fpga417_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_top_fpga417_0_0.tcl
